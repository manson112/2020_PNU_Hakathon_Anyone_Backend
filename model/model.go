...
func Get200Response(jsonString string) Response {
	var r Response
	r.Code = 200
	r.Message = "Success"
...
func Get300Response(jsonString string) Response {
	var r Response
	r.Code = 300
...
func Get400Response(jsonString string) Response {
	var r Response
	r.Code = 400
...
func Get500Response(jsonString string) Response {
	var r Response
	r.Code = 500
	r.Message = "Failure"
	r.ResponseData = jsonString
